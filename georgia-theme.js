...
const basePath = fb.ProfilePath + "georgiaFork\\";
...
function on_paint(gr) {
	...
	gr.DrawString(
		...
		ft_lower,
		col.now_playing,
		progressBar.x + loadingWidth + scaleForDisplay(20),
		lowerBarTop,
		progressBar.w,
		titleMeasurements.Height
	);
	...
	gr.FillSolidRect(
		progressBar.x,
		progressBar.y,
		(progressBar.w * (loadStrs.fileIndex + 1)) / fileList.length,
		progressBar.h,
		col.progressFill
	);
}
